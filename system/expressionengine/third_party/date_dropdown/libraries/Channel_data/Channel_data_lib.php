...
if(!class_exists('Channel_data_lib'))
{
	class Channel_data_lib {
		...
		*/
		...
		{
			return $this->get_relationships($select, array('relationship_id' => $rel_id));
		}
		...
		public function get_relationships($select = array(), $where = array(), $order_by = 'relationship_id', $sort = 'DESC', $limit = FALSE, $offset = 0)
		{
